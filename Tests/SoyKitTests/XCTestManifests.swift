...
extension AppenderTests {
    // DO NOT MODIFY: This is autogenerated, use:
    //   `swift test --generate-linuxmain`
    // to regenerate.
    static let __allTests__AppenderTests = [
        ("testBasicOutput", testBasicOutput),
        ("testEmptyOutput", testEmptyOutput),
        ("testEmptyOutputWithAppend", testEmptyOutputWithAppend),
        ("testHTMLOutputKind", testHTMLOutputKind),
    ]
}
...
public func __allTests() -> [XCTestCaseEntry] {
    return [
        testCase(AppenderTests.__allTests__AppenderTests),
